...
const About = () => {
    return (
        ...
        <h3>Want to customize a version of Tooli for your own business? <a href="mailto:bannan.hannah@gmail.com" target="_blank">Contact the developer here.</a></h3>
        <h4>Created by <a href="https://hannahbannan.github.io/Portfolio" target="_blank">Hannah Bannan</a>, a student at General Assembly.</h4>
        </div>
        </div>
